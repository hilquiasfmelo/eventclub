...
import Fundo from "../assets/back.jpeg";
...
export default class Login extends Component {
  ...
  render() {
    return (
      <ImageBackground source={Fundo} style={styles.containerMain}>
        <KeyboardAvoidingView behavior="padding" style={styles.container}>
          ...
          <View style={styles.inputContainer}>
            <Image
              ...
              source={{
                uri: "https://img.icons8.com/ios-glyphs/100/000000/gmail.png"
              }}
            />
            <TextInput
              style={styles.inputs}
          ...
          <View style={styles.inputContainer}>
            <Image
              ...
              source={{
                uri:
                  "https://img.icons8.com/material-two-tone/100/000000/password--v1.png"
              }}
            />
            <TextInput
              style={styles.inputs}
